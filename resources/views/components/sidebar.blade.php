        ...
        <div class="logo-container">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <div class="logo-text">
                        <div class="fw-bold fs-3 mb-0" style="color: var(--congress-blue); line-height: 1;">ATIN</div>
                        <div class="small text-muted mb-0" style="line-height: 1.1; font-size: 0.75rem;">
        ...
        <div class="dropdown">
            <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle sidebar-user-link" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="flex-grow-1 sidebar-user-info">
                    <div class="fw-bold" style="color: var(--congress-blue); font-size: 0.9rem;">{{ session('user_name') }}</div>
                    <div class="text-muted" style="font-size: 0.75rem;">{{ session('user_role') }}</div>
                </div>
